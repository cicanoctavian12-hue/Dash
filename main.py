...
class TicketPanelView(discord.ui.View):
    ...
    @discord.ui.button(label="Support", style=discord.ButtonStyle.secondary, emoji="<:nightmare:1400923642581221457>", custom_id="ticket_support")
    async def support_button(self, interaction: discord.Interaction, button: discord.ui.Button):
        await self.create_ticket(interaction, "Support")
    
    @discord.ui.button(label="Apply", style=discord.ButtonStyle.secondary, emoji="<:amethyst:1400923845178818732>", custom_id="ticket_apply")
    async def apply_button(self, interaction: discord.Interaction, button: discord.ui.Button):
        await self.create_ticket(interaction, "Apply")
    
    @discord.ui.button(label="Redeem Rewards", style=discord.ButtonStyle.secondary, emoji="<:Crown:1400924187325104258>", custom_id="ticket_redeem")
